...
def gerar_mensagens_comunicado(texto_bruto, nro_reuniao, data_publicacao, selic_anterior=None):
    ...
    prompt = (
        ...
        "🗣️ *Tom do comunicado*: no máximo 1 frase curta e direta descrevendo o tom "
        "(hawkish/dovish, cauteloso, ambíguo, com ou sem forward guidance explícito), "
        "comparando com o padrão de comunicação anterior quando fizer sentido.\n\n"
        ...
        "Bullets com \"▪️\" (quantidade livre, sem mínimo ou máximo fixo), cada um em UMA frase "
        "curta reescrevendo o motivo apresentado pelo Copom — o porquê, não só o fato —, sem "
        ...
        "- Evite jargão sempre que houver alternativa simples em português (ex.: prefira \"preço "
        "do dólar\" a \"câmbio\", \"juros\" a termos técnicos evitáveis). Só explique entre "
        "parênteses, de forma breve, termos técnicos realmente sem substituto direto (ex.: "
        "Selic, p.p., Focus, forward guidance), e apenas na primeira vez que aparecerem.\n\n"
