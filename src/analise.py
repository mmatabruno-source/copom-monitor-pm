...
def gerar_mensagens_comunicado(texto_bruto, nro_reuniao, data_publicacao, selic_anterior=None):
    ...
    prompt = (
        ...
        "[📉 se reduziu / 📈 se elevou / ➡️ se manteve] O Copom "
        "[reduziu/elevou/manteve] a Selic[ em [X] p.p. se reduziu ou elevou — "
        "se manteve, omita \" em [X] p.p.\" e termine a frase em \"a Selic.\"].\n"
        ...
        f"_Obs.: resumo feito com Claude Sonnet 4.6 a partir do comunicado de {data_publicacao} "
        "do Banco Central. Na próxima semana, conforme o Bacen emitir a Ata, você receberá "
        "maiores explicações por este chat._\n\n"
        ...
        "- Em cada seção no formato \"emoji *Rótulo*: texto\" (ex.: \"🗣️ *Tom do "
        "comunicado*: ...\", \"💡 *Leitura prática*: ...\"), a primeira palavra depois dos "
        "dois-pontos começa com letra minúscula (salvo nomes próprios ou siglas), como em "
        "uma continuação de frase.\n"
        "- Já nos bullets \"▪️\" da seção de Justificativas, cada um é uma frase completa e "
        "independente — começa com letra MAIÚSCULA (salvo quando a primeira palavra já é "
        "minúscula por convenção, como sigla) e termina com ponto final.\n"
...
def gerar_analise_ata(texto_estruturado, nro_reuniao, data_publicacao, analise_ata_anterior=None):
    ...
    prompt = (
        ...
        "- Em cada seção no formato \"emoji *Rótulo*: texto\" (ex.: \"🗣️ *Decisão*: ...\", "
        "\"💰 *Impacto nos Investimentos*: ...\"), a primeira palavra depois dos dois-pontos "
        "começa com letra minúscula (salvo nomes próprios ou siglas), como em uma "
        "continuação de frase.\n"
        "- Já nos bullets \"▪️\", cada um é uma frase completa e independente — começa com "
        "letra MAIÚSCULA (salvo quando a primeira palavra já é minúscula por convenção, "
        "como sigla) e termina com ponto final.\n"
        "- Não use negrito (*texto*) em nenhum outro lugar além dos rótulos de seção já "
        "especificados nos templates acima.\n\n"
