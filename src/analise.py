...
def gerar_mensagens_comunicado(texto_bruto, nro_reuniao, data_publicacao, selic_anterior=None):
    ...
    prompt = (
        ...
        "referida como \"pesquisa Focus (projeções das instituições financeiras)\", sem "
...
def gerar_analise_ata(texto_estruturado, analise_ata_anterior=None):
    ...
    prompt = (
        ...
        "Focus (projeções das instituições financeiras), fiscal e externo que são relevantes "
        ...
        "p.p.), use-o direto, sem explicação. A pesquisa Focus deve ser sempre referida como "
        "\"pesquisa Focus (projeções das instituições financeiras)\", sem explicação "
        "adicional.\n"
