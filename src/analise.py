...
def gerar_mensagens_comunicado(texto_bruto, nro_reuniao, data_publicacao, selic_anterior=None):
    ...
    prompt = (
        ...
        "Selic, p.p., Focus), e apenas na primeira vez que aparecerem. \"Forward guidance\" "
        "deve ser sempre evitado — substitua por uma descrição direta em português (ex.: "
        "\"sem sinalização explícita sobre os próximos passos\").\n\n"
